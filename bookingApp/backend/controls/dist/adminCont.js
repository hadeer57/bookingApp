...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, firstName, lastName, email, password, salt, hash, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, userModel_1.UserModel.create({ firstName: firstName, lastName: lastName, email: email, password: hash })];
                case 1:
                    _b.sent();
                    res.send({ ok: true });
                    return [3 /*break*/, 3];
